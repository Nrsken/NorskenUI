...
function CHAR:CreateTrackOverlay(slotFrame, slotID)
    ...
    overlay.text:SetFontStyle("Expressway", 12, "OUTLINE")
...
function CHAR:CreateSocketButton(index)
    ...
    btn:AddBorders()
    btn:SetBorderColor(unpack(Theme.border))
...
function CHAR:CreateGemPopup()
    ...
    popup.title:SetFontStyle("Expressway", 14, "OUTLINE")
    ...
    popup.noGems:SetFontStyle("Expressway", 14, "OUTLINE")
...
function CHAR:CreateGemButton(index)
    ...
    btn.iconFrame:AddBorders()
    btn.iconFrame:SetBorderColor(unpack(Theme.border))
    ...
    btn.stats:SetFontStyle("Expressway", 12, "OUTLINE")
    ...
    btn.count:SetFontStyle("Expressway", 12, "OUTLINE")
...
function CHAR:CreateEnchantPopup()
    ...
    popup.noEnchants:SetFontStyle("Expressway", 14, "OUTLINE")
