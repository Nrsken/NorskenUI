...
function FCB:CreateFrame()
    ...
    castBar:SetStatusBarTexture(NRSKNUI:GetStatusbarPath(NRSKNUI:GetEffectiveStatusBar(db)))
    ...
    positioner:SetStatusBarTexture(NRSKNUI:GetStatusbarPath(NRSKNUI:GetEffectiveStatusBar(db)))
    ...
    kickCooldownBar:SetStatusBarTexture(NRSKNUI:GetStatusbarPath(NRSKNUI:GetEffectiveStatusBar(db)))
...
function FCB:ApplySettings()
    ...
    local texturePath = NRSKNUI:GetStatusbarPath(NRSKNUI:GetEffectiveStatusBar(db))
