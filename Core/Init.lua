...
NRSKNUI.GroupFinder = NRSKNUI:NewModule('GroupFinder', 'AceEvent-3.0')
...
-- BigWigs Timers Module
NRSKNUI.BigWigsTimers = NRSKNUI:NewModule('BigWigsTimers', 'AceEvent-3.0', 'AceTimer-3.0', 'AceHook-3.0')
