...
--		end
	...
	-- Deferred DoLayout to prevent infinite resize loops (NorskenAuras fix)
	local function ContentResizeOnUpdate(frame)
		frame:SetScript("OnUpdate", nil)
		if frame.obj and frame.obj.DoLayout then
			frame.obj:DoLayout()
		end
	end
	...
	local function ContentResize(this)
		if this:GetWidth() and this:GetHeight() then
			...
			-- Defer DoLayout to next frame to prevent infinite resize loops
			this:SetScript("OnUpdate", ContentResizeOnUpdate)
		end
	end
